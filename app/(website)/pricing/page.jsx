...
export default function PricingPage() {
    return (
        <main className="main">
                                    ...
                                    <div className="row gx-4 gy-5">
                                                ...
                                                <div className="cardprice-body">
                                                    ...
                                                    <ul className="packagelist">
                                                        ...
                                                        <li className="packagelist-item">
                                                            ...
                                                            <span className="text">Site SEO</span>
                                                        </li>
                                        ...
                                        <div className="col-md-4">
                                            <div className="cardprice recommended">
                                                <span className="cardbadge">The most popular</span>
                                                ...
                                                <div className="cardprice-header">
                                                    <div className="details">
                                                        ...
                                                        <div className="info">
                                                            <p className="text">
                                                                Our tools are easy to use and will
                                                                help you create a professional,
                                                ...
                                                <div className="cardprice-body">
                                                    ...
                                                    <ul className="packagelist">
                                                        ...
                                                        <li className="packagelist-item">
                                                            ...
                                                            <span className="text">Set Domain</span>
                                                        </li>
                                            ...
                                            <div className="cardprice">
                                                <div className="cardprice-header">
                                                    <div className="details">
                                                        ...
                                                        <div className="info">
                                                            <p className="text">
                                                                You can create beautiful designs by
                                                                using our powerful and simple design
                                                                tools.
                                                            </p>
                                                        </div>
                                                    </div>
                                        ...
                                        <div className="cardpricing">
                                            <div className="cardpricing-header">
                                                <div className="details">
                                                    ...
                                                    <div className="info">
                                                        <p className="text">
                                                            The essentials you need to start selling
                                                            online
                                                        </p>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="cardpricing-body">
                                                <ul className="packagelist">
                                                    <li className="packagelist-item">
                                                        ...
                                                        <span className="text">100 products</span>
                                                    </li>
                                                    ...
                                                    <li className="packagelist-item">
                                                        ...
                                                        <span className="text">
                                                            Realtime shipping quotes from leading
                                                            carriers
                                                        </span>
                                                    </li>
                                            ...
                                            <div className="cardpricing-body">
                                                <ul className="packagelist">
                                                    <li className="packagelist-item">
                                                        ...
                                                        <span className="text">2,500 products</span>
                                                    </li>
            ...
            {/* <!-- DROP-MESSGAGE START --> */}
            <section className="dropmessage">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-8 mx-lg-auto">
                            <div className="dropmessage-content">
                                <h2 className="fw-bold" data-aos="fade-up">
                                    data-aos=&quot;fade-up&quot; Still have some doubts? <br />
